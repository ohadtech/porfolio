  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-30 bg-bgDark">
      ...
      >
        ...
        >
          {/* for mobile view */}
          <span className="sm:hidden">@Adeel</span>
          {/* for web view */}
          <span className="hidden sm:block">@Adeel Memon</span>
        </ScrollLink>
            ...
            >
              <div className="flex flex-col md:hidden bg-bgDark relative p-10">
                ...
                <div className="flex gap-4 p-6 border-b-white border-b-2 text-[22px]">
                  <a
                    href="https://pk.linkedin.com/in/adeel-ghulam-memon"
                    target="_blank"
                  ...
                  <a href="mailto:adeel.memon03000@gmail.com">
                    <HiMailOpen />
                  </a>
                </div>
